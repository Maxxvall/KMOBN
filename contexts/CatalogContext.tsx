...
import { BoardSpec, DuplicateGroup, Material, Work, WorkBundle, SectionId } from '../types';
...
type CatalogContextValue = {
  ...
  onAddMaterial: (name: string, category: SectionId, price?: number, link?: string, boardSpec?: BoardSpec) => Promise<Material | null>;
  ...
  onAddWork: (name: string, category: SectionId, price: number) => Promise<Work | null>;
